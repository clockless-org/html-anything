...
<body>
  <main>
    ...
    <footer>
      <p>Generated by <a href="https://github.com/clockless-org/html-anything">html-anything</a> from <span id="footer-source" class="mono"></span> (<span id="footer-bytes" class="mono"></span>) using the offline kindle-highlights template. This file is fully self-contained and makes no network calls beyond the Google Fonts import shared with every html-anything output.</p>
